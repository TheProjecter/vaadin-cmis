vaadin-cmis-integration README
=================================================
...
CHECKING OUT THE CODE
  ...
  The source code is maintained in vaadin-cmis-integration Subversion repository. To check
  out the latest development version, use the following command:

    $ svn co http://example.com/svn/.../trunk vaadin-cmis-integration

EDITING THE CODE IN AN IDE

  The vaadin-cmis-integration add-on project can be imported in any IDE that supports Maven.
